...
document.addEventListener('DOMContentLoaded', function () {
    ...
    formularioAgendamento.addEventListener('submit', function (event) {
        ...
        //  Obtém os valores dos camps do formulário
    ...
    // Função para o enviar os dados do agendamento para o servidor
    function enviarDadosAgendamento(dados) {
        ...
        fetch('/agendamentos', {
            ...
            .catch(error => {
                alert('Erro ao aguardar.Por favor, tente novamente mais tarde');
            ...
            function criarEvento(dados) {
                gapi.client.calendar.events.insert({
                    ...
                    'resource': {
                        ...
                        'start': {
                            'dateTime': '2025-02-14T10:00:00-03:00' //  Defina a data e hora do agendamento

                        },
                        'end': {
                            'dateTime': '2025-02-14T10:00:00-03:00' //  Defina a data e hora de término
                        }
                    }
